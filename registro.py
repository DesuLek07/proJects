...
class ventana_registro(ventana_principal):
    ...
    def construir_interfaz(self):
        ...
        boton_volver = ctk.CTkButton(frame2, width=2, 
                            height=2, 
                            corner_radius=50, 
                            fg_color='gray19', 
                            text='Volver', text_color='black', 
                            font=ctk.CTkFont(32, weight='bold'), 
                            bg_color='gray17', command=self.volver_ventana_principal)
    
        boton_volver.place(relx=0.5, rely=0.85, anchor='center')
